...
impl TaskManager {
    ...
    fn mark_current_exited(&self) {
        ...
        task.task_end_time = get_time_ms();

        println!("[kernel] task_start_time: {}ms, task_end_time: {}ms, time_elapsed: {}ms", task.task_start_time, task.task_end_time, task.task_end_time-task.task_start_time);
    }
